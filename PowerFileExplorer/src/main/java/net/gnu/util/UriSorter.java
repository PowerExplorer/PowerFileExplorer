...
public class UriSorter implements Comparator<Uri> {
    ...
    public UriSorter(final int dir, final int sort, final int asc) {
        this.dirsOnTop = dir;
        this.asc = asc;
        this.sort = sort;
    }
    ...
    public int compare(final Uri uri1, final Uri uri2) {
		...
		final File file1 = new File(Uri.decode(uri1.getPath()));
		final File file2 = new File(Uri.decode(uri2.getPath()));
