...
//		context = getContext();
//
//        touchImageView = (TouchImageView) view.findViewById(R.id.image);
//        videoPlayImage = (ImageView) view.findViewById(R.id.videoPlayImage);
//		centerInfo = (TextView) rootView.findViewById(R.id.centerInfo);
//		
////		minZoom = TouchImageView.SUPER_MIN_MULTIPLIER * touchImageView.getMinZoom();
////		maxZoom = TouchImageView.SUPER_MAX_MULTIPLIER * touchImageView.getMaxZoom();
//		touchImageView.setZoom(PhotoFragment.curZoom);
...
//		//touchImageView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
//		
...
//		super.onResume();
//		//touchImageView.setLayoutParams(new FrameLayout.LayoutParams(rootView.getMeasuredWidth(), rootView.getMeasuredHeight(), Gravity.CENTER));
//		//touchImageView.getLayoutParams().width = rootView.getMeasuredWidth();
//		//touchImageView.getLayoutParams().height = rootView.getMeasuredHeight();
//		//Log.d(TAG, "onResume1 Visible " + touchImageView.getVisibility() + ", " + touchImageView.getMeasuredWidth() + ", " + touchImageView.getMeasuredHeight());
//		//Log.d(TAG, "onResume2 Visible " + rootView.getMeasuredWidth() + ", " + rootView.getMeasuredHeight());
//		loadImageToView();
//	}
//
//	
...
//	}
//
//    public void setMediaInfo(final Uri mediaInfo) {
...
//                touchX = event.getX();
//                PhotoFragment.curZoom = touchImageView.getCurrentZoom();
...
//            return;
//        }
//        final int oldDelay = PhotoFragment.curDelay;
...
//        if (delta != 0) {
//            PhotoFragment.curDelay += delta;
//			//Log.d(TAG, "curDelay " + curDelay);
//			PhotoFragment.curDelay = Math.min(Math.max(PhotoFragment.curDelay, 500), 60000);
//			//Log.d(TAG, "curDelay " + curDelay);
//			final int drawableId;
//			if (PhotoFragment.curDelay == oldDelay) {
//				drawableId = R.drawable.ic_volume_mute_white_36dp;
//			} else if (PhotoFragment.curDelay > oldDelay) {
//				drawableId = R.drawable.ic_volume_up_white_36dp;
//			} else {
//				drawableId = R.drawable.ic_volume_down_white_36dp;
//			}
...
//			setInfo("Delay " + Util.nf.format(PhotoFragment.curDelay) + " ms", drawableId);
//        }
//    }
//
...
//    }
//
//	public void setOnDoubleTapListener(final PhotoFragment onDoubleTapListener) {
...
//        Log.d(TAG, "loadImageToView mMediaInfo " + mMediaInfo);
//		if (mMediaInfo != null) {
//			if (VIDEO_PATTERN.matcher(mMediaInfo.getPath()).matches()) {
//				videoPlayImage.setVisibility(View.VISIBLE);
//			} else {
//				videoPlayImage.setVisibility(View.GONE);
//			}
//			//showWait();
//            GlideImageLoader.loadMedia(mMediaInfo, context, touchImageView, DiskCacheStrategy.NONE);//, callback);//, mimenew MediaLoader.SuccessCallback() {
////                @Override
