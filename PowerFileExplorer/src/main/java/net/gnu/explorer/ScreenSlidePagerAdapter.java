...
//			mediaPos--;
//		}
//        Log.d(TAG, "getItem pagerPos " + pagerPos + ", mListOfMedia.get(" + mediaPos + ") " + mListOfMedia.get(mediaPos) + ", viewPager.getCurrentItem() " + viewPager.getCurrentItem() + ", size " + size);
//		//if (mediaPos < size) {
...
//    }
//
//    private ImageFragment2 loadImageFragment(final Uri mediaInfo) {//, final String mime
//		Log.d(TAG, "loadImageFragment " + mediaInfo);
//        final ImageFragment2 fragment = new ImageFragment2();
