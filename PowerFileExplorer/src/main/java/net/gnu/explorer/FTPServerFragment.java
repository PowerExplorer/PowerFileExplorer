 ...
 */
public class FTPServerFragment extends Frag implements View.OnClickListener {

    private TextView statusText, username, password, port, sharedPath, timeoutTV;
	...
	private ImageView changeSharedPath;
	private ImageView changeFtpPort;
	private ImageView changeTimeOut;

	private static final String TAG = "FTPServerFragment";
	...
	public void onViewCreated(View rootView, Bundle savedInstanceState) {
        ...
        timeoutTV = (TextView) rootView.findViewById(R.id.text_view_timeout);
        ...
        final ColorPreference colorPreference = activity.getColorPreference();
		...
		changeUser = (ImageView) rootView.findViewById(R.id.changeUser);
		changeUser.setOnClickListener(this);
		changePassword = (ImageView) rootView.findViewById(R.id.changePassword);
		changePassword.setOnClickListener(this);
        changeSharedPath = (ImageView) rootView.findViewById(R.id.changeSharedPath);
		changeSharedPath.setOnClickListener(this);
        changeFtpPort = (ImageView) rootView.findViewById(R.id.changeFtpPort);
		changeFtpPort.setOnClickListener(this);
        changeTimeOut = (ImageView) rootView.findViewById(R.id.changeTimeOut);
		changeTimeOut.setOnClickListener(this);
