...
//        app.ic.loadDrawable(holder.apkIcon,(rowItem.path),null);
...
//                                return true;
//                            case R.id.unins:
//                                final BaseFile f1 = new BaseFile(rowItem.path);
//                                f1.setMode(OpenMode.ROOT);
//
//                                if ((Integer.valueOf(rowItem.getSymlink().substring(0,
//                                        rowItem.getSymlink().indexOf("_"))).intValue() & ApplicationInfo.FLAG_SYSTEM) != 0) {
//                                    // system package
...
//                                baseFile.setName(rowItem.name + "_" +
