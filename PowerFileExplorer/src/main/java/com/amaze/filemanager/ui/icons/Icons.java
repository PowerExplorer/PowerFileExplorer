...
// Video
    ...
    public static boolean isText(String name) {
        ...
        if (res != null && res.intValue() == R.drawable.ic_doc_text_am) return true;
    ...
    public static boolean isVideo(String name) {
        String mimeType = MimeTypes.getMimeType(new File(name));
        Integer res = sMimeIconIds.get(mimeType);
        if (res != null && res.intValue() == R.drawable.ic_doc_video_am) return true;
        if (mimeType != null && mimeType.contains("/")) {
            final String typeOnly = mimeType.split("/")[0];
    ...
    public static boolean isAudio(String name) {
        String mimeType = MimeTypes.getMimeType(new File(name));
        Integer res = sMimeIconIds.get(mimeType);
        if (res != null && res.intValue() == R.drawable.ic_doc_audio_am) return true;
        if (mimeType != null && mimeType.contains("/")) {
            final String typeOnly = mimeType.split("/")[0];
    ...
    public static boolean isCode(String name) {
        ...
        return res != null && res.intValue() == R.drawable.ic_doc_codes;
    }

    public static boolean isArchive(String name) {
        Integer res = sMimeIconIds.get(MimeTypes.getMimeType(new File(name)));
        return res != null && res.intValue() == R.drawable.ic_zip_box_white_36dp;
    }
    ...
    public static boolean isPdf(String name) {
        Integer res = sMimeIconIds.get(MimeTypes.getMimeType(new File(name)));
        return res != null && res.intValue() == R.drawable.ic_doc_pdf;
    }

    public static boolean isPicture(String name) {
        Integer res = sMimeIconIds.get(MimeTypes.getMimeType(new File(name)));
        return res != null && res.intValue() == R.drawable.ic_doc_image;
    }
