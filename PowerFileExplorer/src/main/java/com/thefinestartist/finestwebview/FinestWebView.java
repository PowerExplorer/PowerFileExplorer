...
public class FinestWebView {
	...
	public static class Builder implements Serializable {
		...
		public Builder show(@NonNull String url) {
			show(url, null);
			return this;
		}

//		public Fragment buildFrag(@NonNull String url) {
//			return buildFrag(url, null);
//		}
...
//		protected Fragment buildFrag(String url, String data) {
//			this.url = url;
//			this.data = data;
//			this.key = System.identityHashCode(this);
//
...
//
//			Bundle b = new Bundle();
//			b.putSerializable("builder", this);
//			
