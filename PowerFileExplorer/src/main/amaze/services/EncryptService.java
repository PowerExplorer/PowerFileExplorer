...
public class EncryptService extends Service {
    ...
    void generateNotification(ArrayList<HFile> failedOps, boolean move) {
        ...
        intent.putExtra(ExplorerActivity.TAG_INTENT_FILTER_FAILED_OPS, failedOps);
        ...
        intent=new Intent(ExplorerActivity.TAG_INTENT_FILTER_GENERAL);
        intent.putExtra(ExplorerActivity.TAG_INTENT_FILTER_FAILED_OPS, failedOps);
     ...
     * by {@link ServiceWatcherUtil#handlerThread} while {@link ExplorerActivity#runOnUiThread(Runnable)}
