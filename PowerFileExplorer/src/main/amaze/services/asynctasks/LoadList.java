...
//    Context c;
//    OpenMode openmode;
//    public LoadList(Context c, UtilitiesProviderInterface utilsProvider, boolean back, FileFrag ma, OpenMode openmode) {
...
//                    e.printStackTrace();
//                    return new ArrayList<LayoutElements>();
//                }
//                break;
//            case BOX:
...
//                    }
//                    try {
//                        LayoutElements layoutElements = utilsProvider.getFutils().newElement(//Icons.loadMimeIcon(baseFile.getPath(), !ma.IS_LIST, ma.res), 
