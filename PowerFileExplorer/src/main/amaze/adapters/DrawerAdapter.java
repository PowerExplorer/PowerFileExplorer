...
public class DrawerAdapter extends ArrayAdapter<Item> {
    ...
    public DrawerAdapter(Context context, UtilitiesProviderInterface utilsProvider, ArrayList<Item> values, ExplorerActivity m, SharedPreferences Sp) {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        if (values.get(position).isSection()) {
            ...
            view.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, AndroidUtils.dpToPx(16, m)));
            view.setPadding(0, AndroidUtils.dpToPx(8, m), 0, AndroidUtils.dpToPx(8, m));
            return view;
        } else {
