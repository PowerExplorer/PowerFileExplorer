...
//
//    public RecyclerAdapter(FileFrag m, UtilitiesProviderInterface utilsProvider, ArrayList<LayoutElements> items, Context context) {
//        this.mainFrag = m;
...
//        rowHeight = AndroidUtils.dpToPx(100, m.activity);
...
////                mainFrag.mActionMode = mainFrag.activity.startSupportActionMode(mainFrag.mActionModeCallback);
////            }
//        }
//
//        notifyDataSetChanged();
...
//						//if (!rowItem.lengthStr().equals(mainFrag.goback)) {
...
//
//            int filetype = -1;
//            if (Icons.isPicture((rowItem.getPath().toLowerCase()))) 
//				filetype = 0;
//            else if (Icons.isApk((rowItem.getPath()))) 
//				filetype = 1;
//            else if (Icons.isVideo(rowItem.getPath())) 
//				filetype = 2;
//            else if (Icons.isEncrypted(rowItem.getPath()) && !rowItem.isDirectory()) 
//				filetype = 4;
...
//			ImageThreadLoader imageLoader = new ImageThreadLoader(mainFrag.activity);
...
//                        //mainFrag.ic.loadDrawable(holder.pictureIcon, (rowItem.getPath()), null);
//						imageLoader.displayImage(new File(rowItem.getPath()), mainFrag.getContext(), holder.pictureIcon, 1);
//					} else {
...
//                        //mainFrag.ic.loadDrawable(holder.apkIcon, (rowItem.getPath()), null);
//						imageLoader.displayImage(new File(rowItem.getPath()), mainFrag.getContext(), holder.apkIcon, 1);
//					}
//                }
//            } else if (filetype == 1) {
//                if (mainFrag.SHOW_THUMBS) {
...
//					? FileUtil.getExtension(rowItem.getName()) : null;
...
//                    //main.ic.loadDrawable(holder.apkIcon, (rowItem.getPath()), null);
//                }
//            } else {
//                holder.pictureIcon.setVisibility(View.GONE);
//                holder.apkIcon.setVisibility(View.GONE);
...
////                holder.txtDesc.setText(rowItem.lengthStr());
//        } else {
//            // view is a grid view
//            Boolean checked = myChecked.get(p);
//
...
//                //mainFrag.ic.loadDrawable(holder.imageView1, (rowItem.getPath()), null);
//				imageLoader.displayImage(new File(rowItem.getPath()), mainFrag.getContext(), holder.imageView1, 1);
//            } else if (Icons.isApk((rowItem.getPath()))) {
//                holder.genericIcon.setColorFilter(null);
//                //mainFrag.ic.cancelLoad(holder.genericIcon);
//                //mainFrag.ic.loadDrawable(holder.genericIcon, (rowItem.getPath()), null);
//				imageLoader.displayImage(new File(rowItem.getPath()), mainFrag.getContext(), holder.genericIcon, 1);
//            }
//            if (rowItem.isDirectory())
...
////                holder.date.setText(rowItem.getDate());
////            if (rowItem.lengthStr().equals(mainFrag.goback)) {
////                holder.date.setText(rowItem.lengthStr());
////                holder.txtDesc.setText("");
////            }
...
//											case GDRIVE:
//											case ONEDRIVE:
//												utilsProvider.getFutils().shareCloudFile(rowItem.getPath(), rowItem.getMode(), context);
//												break;
//											default:
//												ArrayList<File> arrayList = new ArrayList<>();
//												arrayList.add(new File(rowItem.getPath()));
//												utilsProvider.getFutils().shareFiles(arrayList, mainFrag.activity, utilsProvider.getAppTheme(), Color.parseColor(mainFrag.fabSkin));
//												break;
//										}
//										return true;
//									case R.id.rename:
...
//										return true;
//									case R.id.cpy:
//										ExplorerActivity activity = mainFrag.activity;
//										mainFrag.activity.MOVE_PATH = null;
...
//										return true;
//									case R.id.cut:
//										ExplorerActivity activity1 = mainFrag.activity;
//										activity1.COPY_PATH = null;
//										ArrayList<BaseFile> copie = new ArrayList<>();
//										copie.add(rowItem.generateBaseFile());
//										activity1.MOVE_PATH = copie;
//										activity1.supportInvalidateOptionsMenu();
//										return true;
//									case R.id.ex:
//										mainFrag.activity.mainActivityHelper.extractFile(new File(rowItem.getPath()));
//										return true;
//									case R.id.book:
//										DataUtils.addBook(new String[]{rowItem.getName(), rowItem.getPath()}, true);
//										mainFrag.activity.updateDrawer();
...
//										utilsProvider.getFutils().deleteFiles(mainFrag.dataSourceL1, mainFrag, positions, utilsProvider.getAppTheme());
//										return true;
//									case R.id.open_with:
//										utilsProvider.getFutils().openWith(new File(rowItem.getPath()), mainFrag.getActivity());
//										return true;
//									case R.id.encrypt:
...
//										return true;
//									case R.id.decrypt:
//										FileFrag.decryptFile(mainFrag, mainFrag.openMode, rowItem.generateBaseFile(),
...
//					String x = rowItem.getPath().toLowerCase();
//					if (rowItem.isDirectory()) {
