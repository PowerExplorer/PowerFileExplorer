...
//    }
    ...
    public void deleteFiles(ArrayList<LayoutElements> a, final ExplorerActivity b, /*List<Integer> pos, */AppTheme appTheme) {
...
//        c.negativeColor(Color.parseColor(b.fabSkin));
        c.callback(new MaterialDialog.ButtonCallback() {
            ...
            public void onPositive(MaterialDialog materialDialog) {
                Toast.makeText(b, b.getResources().getString(R.string.deleting), Toast.LENGTH_SHORT).show();
                b.mainActivityHelper.deleteFiles(todelete);
            }
...
//                            m.openZip(Uri.fromFile(f).toString());
    ...
    public LayoutElements newElement(/*BitmapDrawable i, */final String d, final String permissions, final String symlink, /*String size, */final long longSize, final boolean directorybool, /*boolean b, */final long date) {
        final LayoutElements item = new LayoutElements(/*i, */new File(d).getName(), d,permissions,symlink,/*size, */longSize,/*b,*/date,directorybool);
        return item;
    }
    ...
    public void showSortDialog(final ContentFragment m, AppTheme appTheme) {
...
//    }
    ...
    public void showHistoryDialog(final ContentFragment m, AppTheme appTheme) {
    ...
    public void showHiddenDialog(final ContentFragment m, AppTheme appTheme) {
        final MaterialDialog.Builder a = new MaterialDialog.Builder(m.getActivity());
        a.positiveText(R.string.cancel);
        a.positiveColor(Color.parseColor(BaseActivity.accentSkin));
