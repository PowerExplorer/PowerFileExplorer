    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.onPositive(new MaterialDialog.SingleButtonCallback() {
            ...
            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                if (subnetScanner != null)
                    subnetScanner.interrupt();
                if (getActivity() != null && getActivity() instanceof ExplorerActivity) {
                    dismiss();
                    ExplorerActivity explorerActivity = (ExplorerActivity) getActivity();
                    explorerActivity.showSMBDialog("", "", false);
                }
            }
        });
                ...
                rootView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (getActivity() != null && getActivity() instanceof ExplorerActivity) {
                            dismiss();
                            ExplorerActivity explorerActivity = (ExplorerActivity) getActivity();
                            explorerActivity.showSMBDialog(listViewAdapter.getItem(p).name, listViewAdapter.getItem(p).addr, false);
                        }
                    }
                });
